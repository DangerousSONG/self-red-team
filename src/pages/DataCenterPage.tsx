...
export function DataCenterPage({ onNavigate }: DataCenterPageProps) {
  const { trajectoryDatasets, cptDatasets, vulnerabilityDatasets, traces, cptCorpus, vulnerabilityRecords, results } = useDataCenter()
    ...
    <main className="flex-1 overflow-x-hidden px-6 py-5">
      <div className="mx-auto max-w-[1450px] space-y-5 pb-8">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--color-ink-secondary)]">以数据集为单位管理评测轨迹、CPT 语料和漏洞数据资产</p>
        </div>
